...
assigned: 2018-07-18 09:00:00.00-8
due: 2018-07-22 23:59:00.00-7
---
...
```
  cp /cs/faculty/richert/public_html/cs16/lab03/* ~/cs16/lab03_agaucho_alily/
```
...
-bash-4.2$ pwd
/cs/faculty/richert/cs16/lab03_agaucho_alily/
-bash-4.2$
```
